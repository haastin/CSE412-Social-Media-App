...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws NoSuchAlgorithmException {
        ...
        /*
         * if a user tries to insert something that already exists, a sql exception will
         * be thrown, and the code in
         * the catch is executed, so an error box or whatever can be the code in the
         * catch to address that.
         * 
         * the variables i created are dummy variables that will be populated with data
         * from the labels, etc. So as long as
         * the variables are used with the labels, then everything in the DB side should
         * go freely.
         */
        ...
        register.setOnAction(ev -> {
            ...
            centerPaneRegister.setPadding(new Insets(10, 10, 10, 10)); // this is the spacing from the perimeter of the
                                                                       // window
        ...
        centerPaneSearchUsers.setPadding(new Insets(10, 10, 10, 10)); // this is the spacing from the perimeter of the
                                                                      // window
         ...
         * try{
         * users_who_have_target_user_as_friend =
         * db.getUsersWhoHaveTargetUserAsFriend(target_user_uid);
         * }
         * catch(SQLException e){
         * e.printStackTrace();
         * }
         ...
         * try{
         * matched_user = db.searchUserByName(search_user_firstName,
         * search_user_lastName);
         * }catch(SQLException e){
         * e.printStackTrace();
         * }
         ...
         * try{
         * my_photos_with_tags = db.getPhotosByMultipleTagsAndUser(search_my_tags,
         * curr_user);
         * }catch(SQLException e){
         * e.printStackTrace();
         * }
        ...
        for (String tag : most_popular_tags) {
            ...
            Button pop_tag = new Button(tag);
            pop_tag.setOnAction(event -> {
                sm.switchToTagSearch(false, tag);
            });
            centerPaneMostPopTags.add(pop_tag, 0, i);
            tags[i - 1] = tag;
            i++;
        ...
        /*
         * you may also like- returns list of pids (non-user posted pids) that have the
         * top tags and how many of the top tags they have
         */
    ...
    /*
     * these vars need to be populated by labels/buttons above the db function
     * calls, besides the holder for retrieved data
    ...
    // coomented this out because it deletes the test user when trying to test all
    // my functions
    /*
     * 
     * 
