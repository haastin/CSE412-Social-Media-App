...
public class SceneManager {
    ...
    public Scene youmayAlsoLikeScene;
    private Stage stage;
    ...
    public void switchToTagSearch() {
        // switch to searching for tags
    ...
    void switchToYourFeed(){
        ...
        Button Tag4 = new Button();
        Button Tag5 = new Button();
        ...
        for (Tag tag : tags) {
            ...
            switch (i) {
                case 1:
                    Tag1 = new Button(tag.word);
                    i++;

                case 2:
                    Tag2 = new Button(tag.word);
                    i++;

                case 3:
                    Tag3 = new Button(tag.word);
                    i++;

                case 4:
                    Tag4 = new Button(tag.word);
                    i++;

                default:
                    Tag5 = new Button(tag.word);
                    i++;
            }
        ...
        vBox.setSpacing(5);
        // vBox.setAlignment(Pos.CENTER);
        vBox.getChildren().addAll(feed, hBox3, hBox, hBox2, numLikes, comment0, comment1, TagHeader, Tag1, Tag2, Tag3, Tag4, Tag5);

        for (int j = 0; j < comments.size(); j++) {
            Pair<String, Comment> full_comment = comments.get(j);
            String comm = full_comment.getKey() + " " + full_comment.getValue().text;
            vBox.getChildren().add(new Label(comm));
        }
        ...
        EventHandler<ActionEvent> event = new EventHandler<ActionEvent>() {
            public void handle(ActionEvent e) {
                ...
                if (suggest.getValue().toString().equals("Top Ten Users")) {
                    ...
                    stage.setScene(youmayAlsoLikeScene); // change to you may also like page
                    stage.show();
                }
